...
export default class Order1 extends React.Component {
    ...
    textInput.push(
      <View>
        <Card>
          ...
          <View style={styles.youremail}>
            <Text style={styles.youremailtext}>PICK UP TIME</Text>
          </View>
          ...
          <View style={styles.date}>
            <Text style={styles.datetxt}>PICK UP DATE</Text>
          </View>
          ...
          <View style={styles.youremail}>
            <Text style={styles.youremailtext}>SELECT FILES</Text>
          </View>
          <View style={styles.sectionStyle}>
            <MaterialCommunityIcons
              name="camera"
  ...
  handleConfirm = (DateDisplay) => {
    ...
    this.setState({
      TimeDisplay: moment(DateDisplay).utcOffset("+05:30").format("hh:mm:ss "),
    });
  };
  onPressCancel = () => {
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
        ...
        <Image source={require("../assets/head2.jpg")} style={styles.img} />
        <View
        ...
        >
          <Card>
            ...
            <TouchableOpacity style={styles.sectionStylebox1}>
              <MaterialCommunityIcons
                name="clock-time-nine"
                color="#e5702a"
                size={25}
